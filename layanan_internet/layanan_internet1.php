...
<body>
    <div class="container mt-5">
        <h2>LAYANAN INTERNET</h2><br>

        <form action="" method="POST">

            <!-- Table 1 -->
            <div class="form-group">
                <label for="expectation1">23.Akses internet mudah ditemukan di area Plant KTI</label>
            ...
            <!-- Table 2 -->
            <div class="form-group">
                <label for="expectation2">24.Group OLTI mudah dihubungi jika terjadi error pada jaringan internet</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 3 -->
            <div class="form-group">
                <label for="expectation3">25.Anda merasa aman dalam menggunakan akses internet</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 4 -->
            <div class="form-group">
                <label for="expectation4">26.Anda memahami cara menggunakan internet yang aman</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 5 -->
            <div class="form-group">
                <label for="expectation5">27.Akses internet selalu ada disetiap ruang kerja</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <a class="btn btn-primary" href="../pertanyaan_umum/bagianb2.php" role="button">Back</a>
