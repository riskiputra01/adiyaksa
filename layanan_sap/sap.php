...
<head>
    ...
    <title>Survey Layanan SAP</title>
    ...
    <div class="container mt-5">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                <label for="expectation1">30.Menu yang terdapat pada SAP dapat berfungsi</label>
            ...
            <!-- Table 2 -->
            <div class="form-group">
                <label for="expectation2">31.SAP merespon cepat ketika diakses</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 3 -->
            <div class="form-group">
                <label for="expectation3">32.Anda percaya dengan keakuratan dan kelengkapan data pada SAP</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 4 -->
            <div class="form-group">
                <label for="expectation4">33.Anda mendapatkan pelatihan penggunaan SAP</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 5 -->
            <div class="form-group">
                <label for="expectation5">34.SAP dapat diakses dari kantor dan di luar kantor</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <a class="btn btn-primary" href="../layanan_aplikasi/cek_layanan_apk.php" role="button">Back</a>
