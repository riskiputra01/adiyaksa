...
<body>
    <div class="container mt-5">
        <h2>Data Layanan End User Divace</h2>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <tbody>
                    ...
                    <a class="btn btn-primary" href="bisnis.php" role="button">Back</a>
                    <a class="btn btn-primary" href="internet.php" role="button">Next</a>
                </div>
            </div>
        </div>
