            ...
            <div class="card-body">
                ...
                <tbody>
                    ...
                    $query = "SELECT kuisioner, 
                              ...
                              FROM survey 
                              WHERE layanan = 'Layanan Internet' 
                              GROUP BY kuisioner";
                    ...
                    <a class="btn btn-primary" href="eud.php" role="button">Back</a>
                    <a class="btn btn-primary" href="sap.php" role="button">Next</a>
                </div>
            </div>
        </div>
