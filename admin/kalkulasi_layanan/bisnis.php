...
<head>
    ...
    <style>
        ...
        .chart-container {
            margin-top: 40px;
            max-width: 700px; /* Ukuran grafik lingkaran sedang */
            margin: auto;
        }
    </style>
</head>
<body>
    <div class="container mt-5">
        <h2>Data Layanan Solusi Bisnis</h2>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT kuisioner, 
                                      ...
                                      FROM survey 
                                      WHERE layanan = 'Layanan Solusi Bisnis' 
                                      GROUP BY kuisioner";
                    ...
                    <a class="btn btn-primary" href="umum.php" role="button">Back</a>
                    <a class="btn btn-primary" href="eud.php" role="button">Next</a>
                </div>
            </div>
        </div>
