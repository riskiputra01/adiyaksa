...
<head>
    ...
    <title>Survey Layanan Solusi Bisnis</title>
...
<body>
    <div class="container mt-5">
        <h2>LAYANAN C LAYANAN SOLUSI BISNIS</h2>

        <form action="" method="POST">

            <!-- Table 1 -->
            <div class="form-group">
                <label for="expectation1">35.Kebutuhan (spesifikasi) solusi aplikasi/teknologi yang disampaikan sudah sesuai dan kami pahami dengan baik</label>
            ...
            <!-- Table 2 -->
            <div class="form-group">
                <label for="expectation2">36.Pengembangan aplikasi/teknologi dilaksanakan sesuai dengan waktu kesepakatan</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 3 -->
            <div class="form-group">
                <label for="expectation3">37.Solusi Pengembangan Aplikasi/Teknologi untuk kebutuhan bisnis yang diberikan dengan kualitas baik sesuai dengan spesifikasi yang dibutuhkan</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 4 -->
            <div class="form-group">
                <label for="expectation4">38.Ketika terdapat permasalahan bisnis, terdapat minat untuk menyelesaikannya dengan sistem informasi/teknologi informasi</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 5 -->
            <div class="form-group">
                <label for="expectation5">39.Solusi Pengembangan Aplikasi/Teknologi untuk kebutuhan bisnis sudah terdapat petunjuk untuk penggunaannya</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <a class="btn btn-primary" href="../layanan_aplikasi/layanan_apk.php" role="button">Back</a>
