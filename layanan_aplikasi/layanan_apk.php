...
<head>
    ...
    <title>Survey Layanan Aplikasi</title>
    ...
    <div class="container mt-5">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                <label for="expectation1">30.Menu yang terdapat pada aplikasi dapat berfungsi</label>
            ...
            <!-- Table 2 -->
            <div class="form-group">
                <label for="expectation2">31.Tersedia kontak/media untuk melaporkan keluhan dengan respon perbaikan yang cepat</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 3 -->
            <div class="form-group">
                <label for="expectation3">32.Aplikasi tersedia untuk digunakan selama jam kerja dan diluar jam kerja</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 4 -->
            <div class="form-group">
                <label for="expectation4">33.Aplikasi memiliki fitur yang berguna dan sesuai dengan yang saya butuhkan</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 5 -->
            <div class="form-group">
                <label for="expectation5">34.Aplikasi memiliki tampilan (User Interface) yang menarik dan mudah digunakan (User Friendly)</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <a class="btn btn-primary" href="cek_layanan_apk.php" role="button">Back</a>
