...
<div class="container">
    <h2>Layanan Aplikasi / Software</h2>

    <form id="kuesionerForm">
        <div class="form-group">
            <label for="layanan">Apakah Anda Menggunakan SAP S4/HANA</label>
        ...
        <div class="form-group">
        <button><a class="btn btn-primary" href="../layanan_cctv/cek_cctv.php" role="button">Back</a></button>
...
<script>
    document.getElementById('kuesionerForm').addEventListener('submit', function(event) {
        ...
        if (selectedOption === 'Ya') {
            window.location.href = '../layanan_sap/sap.php';
        } else if (selectedOption === 'Tidak') {
            window.location.href = 'layanan_apk.php';
        }
    });
</script>
