...
<body>
    <div class="container mt-5">
        <h2>BAGIAN B PERTANYAAN UMUM</h2><br>
        <form action="" method="POST">

            <!-- Table 1 -->
            <div class="form-group">
                <label for="expectation1">13.Layanan SI/TI dapat diandalkan</label>
            ...
            <!-- Table 2 -->
            <div class="form-group">
                <label for="expectation2">14.Layanan SI/TI tersedia sesuai dengan waktu yang dijanjikan</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 3 -->
            <div class="form-group">
                <label for="expectation3">15.Seluruh layanan SI/TI sudah diinformasikan kepada Anda</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 4 -->
            <div class="form-group">
                <label for="expectation4">16.Staff di Group OLTI selalu memberikan bantuan kepada Anda</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 5 -->
            <div class="form-group">
                <label for="expectation5">17.Layanan SI/TI disediakan perusahaan di tempat kerja Anda</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <a class="btn btn-primary" href="../Layanan/index.php" role="button">Back</a>
