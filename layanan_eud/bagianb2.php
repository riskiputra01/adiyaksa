...
<head>
    ...
    <title>Survey Pertanyaan Umum</title>
...
<body>
    <div class="container mt-5">
        <h2>BAGIAN B</h2>
        <br><h5>Layanan End User Devices (EUD) PC, Laptop, Printer, dll.</h5>

        <form action="" method="POST">

            <!-- Table 1 -->
            <div class="form-group">
                <label for="expectation1">18.Fasilitas EUD (PC, Laptop, Printer dll) dilakukan update</label>
            ...
            <!-- Table 2 -->
            <div class="form-group">
                <label for="expectation2">19.Fasilitas EUD (PC, Laptop, Printer, dll) selalu dirawat sesuai jadwal</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 3 -->
            <div class="form-group">
                <label for="expectation3">20.Fasilitas EUD (PC, Laptop, Printer, dll) dapat digunakan dengan baik</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 4 -->
            <div class="form-group">
                <label for="expectation4">21.Jadwal Preventive Maintenance EUD (PC, Laptop, Printer, dll) selalu diinformasikan sebelum pelaksanaan kegiatan</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <!-- Table 5 -->
            <div class="form-group">
                <label for="expectation5">22.Adanya kepastian dalam mendapatkan perangkat EUD Desktop, Laptop, Printer, dll,sesuai dengan uraian pekerjaan (jobdesc)</label>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
            ...
            <a class="btn btn-primary" href="bagianb1.php" role="button">Back</a>
